...
public class Cluster {
	...
	public void createCluster(String testCase, JSONObject requestJsonObject,
			Map<String, Object> expectedAttributeValues, Map<String, String> responseAttributePaths) throws Exception {

		ResponseBody response = TestAutomationUtil.methodForPost(TestAutomationUtil.getPropertyByName("PMS"), "cluster/createCluster",
				requestJsonObject);
	...
	@SuppressWarnings("rawtypes")
	@Test(dataProvider = "sampleDataProviderget", priority = 1)
	public void getCluster(String testCase, JSONObject requestJsonObject, Map<String, Object> expectedAttributeValues,
		...
		ResponseBody response = TestAutomationUtil.methodForPost(TestAutomationUtil.getPropertyByName("PMS"),
				"cluster/getCluster", requestJsonObject);	
	...
	public void updateCluster(String testCase, JSONObject requestJsonObject, Map<String, Object> expectedAttributeValues,
			Map<String, String> responseAttributePaths) throws Exception {
		ResponseBody response = TestAutomationUtil.methodForPost(TestAutomationUtil.getPropertyByName("PMS"),
				"cluster/updateCluster", requestJsonObject);

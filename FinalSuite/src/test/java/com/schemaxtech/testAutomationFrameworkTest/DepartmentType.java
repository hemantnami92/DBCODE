...
public class DepartmentType {
	...
	@Test(dataProvider = "sampleDataProviderget")
	public void createdepartmenttype(String testCase, JSONObject requestJsonObject,
		...
		ResponseBody response = TestAutomationUtil.methodForPost(TestAutomationUtil.getPropertyByName("PMS"),
				"departmentType/createdepartmenttype", requestJsonObject);

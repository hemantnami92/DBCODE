...
public class Plant {
	...
	public void createPlant(String testCase, JSONObject requestJsonObject, Map<String, Object> expectedAttributeValues,
			Map<String, String> responseAttributePaths) throws Exception {

		ResponseBody response = TestAutomationUtil.methodForPost(TestAutomationUtil.getPropertyByName("PMS"), "plant/createPlant",
				requestJsonObject);
		...
		@SuppressWarnings("rawtypes")
	@Test(dataProvider = "sampleDataProviderget", priority = 1)
	public void getPlant(String testCase, JSONObject requestJsonObject, Map<String, Object> expectedAttributeValues,
			Map<String, String> responseAttributePaths) throws Exception {
	 
		ResponseBody response = TestAutomationUtil.methodForPost(TestAutomationUtil.getPropertyByName("PMS"),
				"plant/getPlant", requestJsonObject);	
	...
	public void updatePlant(String testCase, JSONObject requestJsonObject, Map<String, Object> expectedAttributeValues,
			Map<String, String> responseAttributePaths) throws Exception {
